...
public class GamePageLarge extends AppCompatActivity {
    private static final String FILE_NAME="GameData.txt";
    final private int large = 15, sides = 4;
    ...
    private int active = -1, holder, adCounterHard, pallet, isChallenge, isColorBlind, moveCount;
    private int[][] squares;
    ...
    public void setAdCounterHard(int adCounterHard) { this.adCounterHard = adCounterHard; }
    public int getAdCounterHard() { return this.adCounterHard; }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSquares(build.BuildSquares(getLarge()));

        this.finished = new boolean[getLarge()];

        setContentView(R.layout.game_page_hard);
        victoryScreen(false);
        for(int x = 0; x < getLarge(); x++) {
            setFinished(x, false);
        }
    ...
    public void game() {
        ...
        FrameLayout[] square = { (FrameLayout)findViewById(R.id.squareOneFrame), (FrameLayout)findViewById(R.id.squareTwoFrame),
                ...
                (FrameLayout)findViewById(R.id.squareNineFrame), (FrameLayout)findViewById(R.id.squareTenFrame), (FrameLayout)findViewById(R.id.squareElevenFrame),
                (FrameLayout)findViewById(R.id.squareTwelveFrame), (FrameLayout)findViewById(R.id.squareThirteenFrame), (FrameLayout)findViewById(R.id.squareFourteenFrame),
                (FrameLayout)findViewById(R.id.squareFifteenFrame) };
        ...
        FrameLayout[] squareHolder = { (FrameLayout)findViewById(R.id.squareOne), (FrameLayout)findViewById(R.id.squareTwo),
                ...
                (FrameLayout)findViewById(R.id.squareNine), (FrameLayout)findViewById(R.id.squareTen), (FrameLayout)findViewById(R.id.squareEleven),
                (FrameLayout)findViewById(R.id.squareTwelve), (FrameLayout)findViewById(R.id.squareThirteen), (FrameLayout)findViewById(R.id.squareFourteen),
                (FrameLayout)findViewById(R.id.squareFifteen) };
        ...
        ImageView[][] squaresImg = {
                ...
                { (ImageView) findViewById(R.id.squareTenTop), (ImageView) findViewById(R.id.squareTenBottom),
                        (ImageView) findViewById(R.id.squareTenLeft), (ImageView) findViewById(R.id.squareTenRight) },
                { (ImageView) findViewById(R.id.squareElevenTop), (ImageView) findViewById(R.id.squareElevenBottom),
                        (ImageView) findViewById(R.id.squareElevenLeft), (ImageView) findViewById(R.id.squareElevenRight) },
                { (ImageView) findViewById(R.id.squareTwelveTop), (ImageView) findViewById(R.id.squareTwelveBottom),
                        (ImageView) findViewById(R.id.squareTwelveLeft), (ImageView) findViewById(R.id.squareTwelveRight) },
                { (ImageView) findViewById(R.id.squareThirteenTop), (ImageView) findViewById(R.id.squareThirteenBottom),
                        (ImageView) findViewById(R.id.squareThirteenLeft), (ImageView) findViewById(R.id.squareThirteenRight) },
                { (ImageView) findViewById(R.id.squareFourteenTop), (ImageView) findViewById(R.id.squareFourteenBottom),
                        (ImageView) findViewById(R.id.squareFourteenLeft), (ImageView) findViewById(R.id.squareFourteenRight) },
                { (ImageView) findViewById(R.id.squareFifteenTop), (ImageView) findViewById(R.id.squareFifteenBottom),
                        (ImageView) findViewById(R.id.squareFifteenLeft), (ImageView) findViewById(R.id.squareFifteenRight) } };
        ...
        * Invalid squares are at indexes 12, 13, 14                                                                                                     *
        ...
        * Invalid squares are at indexes 0, 3, 6, 9, 12                                                                                                 *
        ...
        * Invalid squares are at indexes 2, 5, 8, 11, 14                                                                                                *
        ...
        */
        squaresImg[0][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            ...
            public void onSwipeDown() {
                ...
                if(getActive() != 12 && getActive() != 13 && getActive() != 14) {
            ...
            public void onSwipeLeft() {
                ...
                if(getActive() != 0 && getActive() != 3 && getActive() != 6 && getActive() != 9 && getActive() != 12) {
            ...
            public void onSwipeRight() {
                ...
                if(getActive() != 2 && getActive() != 5 && getActive() != 8 && getActive() != 11 && getActive() != 14) {
        ...
        squaresImg[7][0].setOnTouchListener(new OnSwipeTouchListener(this) { //middle square
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
        ...
        squaresImg[8][0].setOnTouchListener(new OnSwipeTouchListener(this) { //after middle square
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
        ...
        squaresImg[9][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
                if (!getFinished(9)) {
                    ...
                    square[9].animate().rotation(360).setStartDelay(30).setDuration(1000);
                }
            }
        ...
        squaresImg[10][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
                if (!getFinished(10)) {
                    ...
                    square[10].animate().rotation(360).setStartDelay(30).setDuration(1000);
                }
            }
        ...
        squaresImg[11][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
                if (!getFinished(11)) {
                    ...
                    square[11].animate().rotation(360).setStartDelay(30).setDuration(1000);
                }
            }
        ...
        squaresImg[12][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
                if (!getFinished(12)) {
                    ...
                    square[12].animate().rotation(360).setStartDelay(30).setDuration(1000);
                }
            }
        ...
        squaresImg[13][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
                if (!getFinished(13)) {
                    ...
                    square[13].animate().rotation(360).setStartDelay(30).setDuration(1000);
                }
            }
        ...
        squaresImg[14][0].setOnTouchListener(new OnSwipeTouchListener(this) {
            @Override
            public void onClick() {
                // your on click here
                super.onClick();
                if (!getFinished(14)) {
                    ...
                    square[14].animate().rotation(360).setStartDelay(30).setDuration(1000);
                }
            }
    ...
    public void testGameFinish() {
        ...
        for(int x = 0; x < getLarge(); x++) {
            for(int y = 1; y < getSides(); y++) {
                ...
                if(((getLarge()-1)/2)>x && getSquares(x, y) == getSquares(x, 0)) {
                    counter++;
                    if(counter == 3) {
                        squareFinished = true;
                    } else {
                ...
                else if(((getLarge()-1)/2) == x) {
                    squareFinished = false;
                    break;
                }
                else if(x>((getLarge()-1)/2) && getSquares(x, y) == getSquares(x, 0)) {
                    counter++;
                    if (counter == 3) {
                        squareFinished = true;
                    } else {
        ...
        if(finishedSquareCount == getLarge() -1) {
    ...
    public void victoryScreen(boolean finished) {
        ...
        if(finished) {
            ...
            setAdCounterHard(getAdCounterHard()+1);
    ...
    public void gameData(char action) {
        ...
        int adCounterEasy = 0, adCounterMedium = 0;
        ...
        if(action == 'r') {
            ...
            if (!file.exists()) {
                ...
                try {
                    ...
                    setAdCounterHard(Integer.parseInt(splitAgain[7]));
        ...
        InterstitialAd.load(this, "ca-app-pub-3940256099942544/1033173712", adRequest,
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                if (mInterstitialAd != null) {
                    ...
                    mInterstitialAd.show(GamePageLarge.this);
            ...
            public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                ...
                setAdCounterHard(getAdCounterHard());
            }
        });
    }
}
